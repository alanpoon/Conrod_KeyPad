...
use glium::Surface;
use conrod_keypad::load_svg::SvgKeypad;
use conrod_keypad::custom_widget::svg::SvgWidget;
const WIDTH: u32 = 600;
...
fn main() {
    ...
    'render: loop {
        ...
        for event in events.drain(..) {
            ...
            SvgWidget::new(svg_keypad.spacebar.clone()).wh([200.0,200.0]).color(color::WHITE).middle().set(ids.text, ui);
        }
