...
pub fn populate(image_id: conrod::image::Id,
    ...
    KeyButton(KeyVariant::Closure(ClosureVariant::EdgeRow3(ImageOrString::Image([images[2],images[2]])),Box::new(|te,_|{te.pop();}))), //backspace
    KeyButton(KeyVariant::Closure(ClosureVariant::EdgeRow4(ImageOrString::StringOnly([String::from("?123"),String::from("?123")])),Box::new(|te,kpv|{*kpv = KeyPadVariant::Num(1);}))),
    ...
    */];
    ...
    KeyButton(KeyVariant::Closure(ClosureVariant::EdgeRow3(ImageOrString::StringOnly([String::from("1/3"),String::from("2/3")])),Box::new(|te,kpv|{
        match kpv{
            &mut KeyPadVariant::Num(1)=>{
    ...
    KeyButton(KeyVariant::Num(String::from(","),String::from("©"))),
    KeyButton(KeyVariant::Closure(ClosureVariant::EdgeRow3(ImageOrString::Image([images[2],images[2]])),Box::new(|te,_|{te.pop();}))), //backspace
    KeyButton(KeyVariant::Closure(ClosureVariant::EdgeRow4(ImageOrString::StringOnly([String::from("abc"),String::from("abc")])),Box::new(|te,kpv|{*kpv=KeyPadVariant::Num(1);}))),
    KeyButton(KeyVariant::Spacebar(images[3],String::from(" "))),
    KeyButton(KeyVariant::StringOnly(String::from("."))),
    KeyButton(KeyVariant::Closure(ClosureVariant::EdgeRow4(ImageOrString::Image([images[4],images[4]])),Box::new(|te,_|{
        let new_string = te.chars().chain(" \\".chars()).collect();
        *te= new_string;
        }))) //new line
        */];
    (letter_vec, number_vec)
